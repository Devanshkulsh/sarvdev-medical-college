        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground max-w-2xl mx-auto">
              A structured framework of statutory, academic, and student-centric
              committees formed to ensure effective governance, quality
              assurance, regulatory compliance, and holistic development within
              the institution.
            </p>
          </div>
