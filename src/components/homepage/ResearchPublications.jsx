      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {researchPublications.map((item) => (
            <article
              key={item.id}
              className="h-full bg-white border border-[#E6E1DD] rounded-xl shadow-sm
                         hover:shadow-md transition flex flex-col p-6"
            >
              {/* Title */}
              <h3 className="text-base font-semibold text-[#2A1E1A] leading-snug mb-4">
                {item.title}
              </h3>

              {/* Authors */}
              <div className="flex items-start gap-2 text-sm text-[#6B5A52] mb-3">
                <Users className="w-4 h-4 mt-0.5 text-[#8B1E1E]" />
              ...
              {/* Publisher */}
              <p className="text-xs uppercase tracking-wide text-[#6B5A52] mb-6">
                {item.publisher}
              </p>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-sm font-medium
                           text-[#8B1E1E] hover:underline mt-auto"
              >
